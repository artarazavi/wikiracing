...
def test_bulk_add_to_new_links_traversed_paths(history_cls):
    ...
    assert history_cls.get_new_links_traversed_path("path4") == ["path1", "path2", "path3", "path4"]
    assert history_cls.get_new_links_traversed_path("path5") == ["path1", "path2", "path3", "path5"]
    assert history_cls.get_new_links_traversed_path("path6") == ["path1", "path2", "path3", "path6"]
